...
* Excercise 1
** Problem 2                                                           :Beta:
     Beta corporation is a utility company whose corporate tax rate is 33%. The reference free risk rate is equal to 3% and the expected market return is 9%. Using data on beta comparables and assuming kD = kTS and βD = 0 shown in the following table determine the kEU value of the company.
