...
* TODO Value in Corporate Control
** Price Formation
*** Competitive Market
...
* Excercise 1
** Problem 2                                                           :Beta:
     ACME corporation is a utility company whose corporate tax rate is 33%. The reference free risk rate is equal to 3% and the expected market return is 9%. Using data on beta comparables and assuming kD = kTS and βD = 0 shown in the following table determine the kEU value of the company.
...
| # | Net debt | leverage ratio | Unleverd Beta |
|---+----------+----------------+---------------|
...
** Problem 3                                                             :EV:
     ...
     - Beta‚ asset unlevered EV, levered EV and equity value with APV (assuming risk free debt and kTXA = kD)
...
| Divestitures                |      0 |  340.0 |
| Account payables            |  410.0 |  380.0 |
